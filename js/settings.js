...
endYear     = 2024;  // last year of budget data
activeYear  = 2024;  // default year to select
...
projectionStartYear = 2023; // if some numbers are projections into the future, set as year of first projection. otherwise, set null. it is assumed that estEndYear = endYear. this determines the chart x axis band
...
inflation_idx = {
    ...
    2020: 257.0, 2021: 260.1, 2022: 276.3, 2023: 296.7, 2024: 307.7
}
